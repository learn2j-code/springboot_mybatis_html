...
public class HeroController {
    ...
    public @ResponseBody List<HeroExtend> findAllDetail() throws Exception {

        return heroService.findAllDetail();
    }
    
    /*页面跳转 部分*/
    @RequestMapping(value="/testWebservice", method=RequestMethod.GET)
    public ModelAndView testWebservice(){
        ModelAndView mv = new ModelAndView("testWebservice");
        return mv;
    }
}
